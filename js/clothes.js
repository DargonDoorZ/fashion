	...
	//ajax
		$.ajax({
			...
			success:function(del){
				var con1 = " ";
					con1+=`
						<p id="small1"class="luck" ><img src="${del[1].small1}" alt=""></p>
						<p id="small2"><img src="${del[1].small2}" alt=""></p>
						<p id="small3"><img src="${del[1].small3}" alt=""></p>
						<p id="small4"><img src="${del[1].small4}" alt=""></p>
						<div id="big1" style="display:block;"><img src="${del[1].big1}" alt=""></div>
						<div id="big2"><img src="${del[1].big2}" alt=""></div>
						<div id="big3"><img src="${del[1].big3}" alt=""></div>
						<div id="big4"><img src="${del[1].big4}" alt=""></div>
					`
					$(".turnShow").html(con1);
				var scp2 = " ";
					scp2+=`
				...
				var scp3 = " ";
					scp3+=`
						<span style="margin-right:10px;">${del[1].moneyNow}</span>
						<span>${del[1].moneyBefore}</span>
					`
					$(".money").html(scp3);
				var scp4c1 = " ";
					scp4c1 +=`
				...
				var size = " ";
					size+=`
						<span>${del[1].size[0]}</span>
						<span>${del[1].size[1]}</span>
						<span>${del[1].size[2]}</span>
						<span>${del[1].size[3]}</span>
						<span>${del[1].size[4]}</span>
					`
					$(".sCp-5").html(size);
				var pic = "";
					pic+=`
						<img src="${del[1].sp1}" alt="" />
						<img src="${del[1].sp2}" alt="" />
						<img src="${del[1].big1}" alt="" />
						<img src="${del[1].big2}" alt="" />
						<img src="${del[1].big3}" alt="" />
						<img src="${del[1].sp3}" alt="" />
						<img src="${del[1].big4}" alt="" />
						<img src="${del[1].sp3}" alt="" />
						<img src="${del[1].sp4}" alt="" />
						<img src="${del[1].sp5}" alt="" />
					`
					$(".GDPics").html(pic);
				var reply = " ";
					for(var i = 0;i<del[1].reply.length;i++){
						reply+=`
							<p class="UEPic">
								<img src="${del[1].reply[i]}" alt="" />
							</p>
						`
					}
					$(".UEPics").html(reply);
				var glshow = " ";
					for(var i = 0;i<del[1].guessLike.length;i++){
						glshow+=`
							<div class="GLChild">
								<img src="${del[1].guessLike[i]}" alt="" />
							</div>
						`
				var btn = "";
					btn+=`
						<div class="sCp-6-1" id = "${del[1].id}">加入购物车</div>
			...
			//左右切换图片
				...
				$("#small1").click(function(){
					$("#IMG").attr("src","images/cb1_2.jpg")
				})	
				$("#small2").click(function(){
					$("#IMG").attr("src","images/cb3_2.jpg")
				})
				$("#small3").click(function(){
					$("#IMG").attr("src","images/cb2_2.jpg")
				})
				$("#small4").click(function(){
					$("#IMG").attr("src","images/cb4_2.jpg")
				})	
				...
				$.ajax({
					...
					success: function(del){
						...
						for(var i = 0; i < cookie_arr.length; i++){
							$(
								`<div class="SCNow">
									<div class = "SCPic" style="float:left">
										<img  class="bug" src="${del[cookie_arr[i].id].small1}" alt="" />
									</div>
									<div class = "SCTitle" style="float:left">
